                            ...
                            news.map((item, idx) => {
                                return <div key={idx} className="py-8 flex flex-wrap md:flex-nowrap">
                                    ...
                                    <div className="md:flex-grow">
                                        ...
                                        <Link to={item.url} className="text-teal-500 hover:text-teal-700 flex flex-row items-center mt-4 justify-start"><p>Read More</p> <ArrowRightAltIcon className='text-teal-500 hover:text-teal-700 mx-1' />
                                        </Link>
                                    </div>
                                </div>
                            })
